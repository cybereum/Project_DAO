...
- [../protocol/audit-findings.md](../protocol/audit-findings.md) — Detailed audit findings
- [../_todo.md](../_todo.md) — Granular work items
- [../knowledge-base/patterns/diamond-proxy.md](../knowledge-base/patterns/diamond-proxy.md) — Contract splitting approach
