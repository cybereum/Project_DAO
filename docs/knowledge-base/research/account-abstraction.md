...
- [../concepts/agent-economies.md](../concepts/agent-economies.md) — Agent UX considerations
- [ai-agent-protocols.md](ai-agent-protocols.md) — How other protocols handle agent wallets
- [../references/eip-standards.md](../references/eip-standards.md) — EIP-4337 specification
- [../../product/roadmap.md](../../product/roadmap.md) — Potential future work stream
