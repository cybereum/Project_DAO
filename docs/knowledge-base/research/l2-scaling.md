...
1. **Contract splitting required** regardless of L2 (most enforce 24 KB). See [../patterns/diamond-proxy.md](../patterns/diamond-proxy.md).
...
- [../../protocol/audit-findings.md](../../protocol/audit-findings.md) — C-1: contract size blocker
- [../../product/roadmap.md](../../product/roadmap.md) — WS6: L2 deployment
- [../patterns/diamond-proxy.md](../patterns/diamond-proxy.md) — Contract splitting for size limit
