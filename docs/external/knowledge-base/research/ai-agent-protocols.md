...
- [cross-chain-interop.md](../../../internal/architecture/cross-chain-interop.md) — Multi-protocol interoperability
- [account-abstraction.md](../../../internal/architecture/account-abstraction.md) — Improving agent wallet UX
