...
| [audit-findings.md](../../internal/dev/audit-findings.md) | AI-assisted audit: 2 critical, 6 high, 13 medium findings + remediation status | Current |
...
- [../knowledge-base/patterns/diamond-proxy.md](../../internal/architecture/diamond-proxy.md) — Contract splitting pattern (needed for mainnet)
