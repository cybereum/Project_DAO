...
- [roadmap.md](../../internal/planning/roadmap.md) — Future plans
- [deployment-readiness.md](../../internal/planning/deployment-readiness.md) — Current readiness
- [../protocol/audit-findings.md](../../internal/dev/audit-findings.md) — What was fixed and when
