...
- [../../protocol/architecture.md](../../external/protocol/architecture.md) — Current monolithic architecture
- [../../protocol/audit-findings.md](../dev/audit-findings.md) — C-1: size blocker
- [../../product/roadmap.md](../planning/roadmap.md) — WS4: contract splitting
- [../research/l2-scaling.md](l2-scaling.md) — L2 deployment requires splitting
- [upgradeable-contracts.md](../../external/knowledge-base/patterns/upgradeable-contracts.md) — Related upgradeability patterns
