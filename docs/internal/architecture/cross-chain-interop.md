...
- [../concepts/agent-economies.md](../../external/knowledge-base/concepts/agent-economies.md) — Multi-chain agent implications
- [ai-agent-protocols.md](../../external/knowledge-base/research/ai-agent-protocols.md) — How other protocols handle multi-chain
- [../../product/roadmap.md](../planning/roadmap.md) — WS6: deployment planning
