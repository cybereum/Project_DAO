...
- [builder-integration.md](../../external/guides/builder-integration.md) — Development setup
- [../protocol/security-model.md](../../external/protocol/security-model.md) — What the tests protect
- [../product/deployment-readiness.md](../planning/deployment-readiness.md) — Test coverage scores
