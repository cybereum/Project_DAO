/**
 * Mock / demo data for the NEXUS frontend.
 *
 * Used ONLY when no on-chain contract is configured (local dev, demos).
 * When VITE_PROJECT_DAO_ADDRESS is set the store initialises with empty
 * arrays and populates from the chain.
 */
