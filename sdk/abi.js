...
export const PROJECT_DAO_ABI = [
  ...
  'function attachEncryptedAgreementPayloadSigned(uint256 _agreementId, address[] calldata _recipients, string[] calldata _ciphertexts, bytes32 _contentHash, address[] calldata _expectedSigners, bytes[] calldata _signatures) external',
  ...
  'function attachEncryptedPaymentRequestPayloadSigned(uint256 _requestId, string calldata _ciphertextForRequester, string calldata _ciphertextForPayer, bytes32 _contentHash, bytes calldata _requesterSignature, bytes calldata _payerSignature) external',
